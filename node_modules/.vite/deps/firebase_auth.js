import {
  ...
  querystringDecode,
  registerVersion
} from "./chunk-CCHYV7MY.js";
import "./chunk-DC5AMYBS.js";

// node_modules/firebase/node_modules/@firebase/auth/dist/esm/index-DGK4UgBf.js
var FactorId = {
      ...
      retrieveSiteKey(this.auth).then(async (siteKey) => {
        ...
        _RecaptchaEnterpriseVerifier.scriptInjectionDeferred) {
          ...
          window[RECAPTCHA_ENTERPRISE_ONLOAD_CALLBACK_NAME] = () => {
            var _a;
            (_a = _RecaptchaEnterpriseVerifier.scriptInjectionDeferred) == null ? void 0 : _a.resolve();
          };
          _loadJS(url).then(() => {
            var _a;
            return (_a = _RecaptchaEnterpriseVerifier.scriptInjectionDeferred) == null ? void 0 : _a.promise;
          }).then(() => {
            retrieveRecaptchaToken(siteKey, resolve, reject);
          }).catch((error) => {
            reject(error);
...
@firebase/auth/dist/esm/index-DGK4UgBf.js:
  (**
   * @license
